...
public class Constants extends RobotConstants {
        ...
        public static class VisionConstants {
                ...
                public static final PIDConstants VISION_PID = new PIDConstants(0, 0.0134, 0.02, 0.00003);
        ...
        public static class HopperConstants {
                ...
                public static final double[] BALL_SPACING = {-25, -27.5, -8, -25};//{ -25, -20, -20, -20 }; //offsets for the spacing out the balls in the hopper
